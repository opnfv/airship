...
run_tests() {
  ...
  sudo docker run -it --env-file env --network host \
      ...
      -v ${FUNCTEST_CACHE}/tempest_conf.yaml:/usr/lib/python2.7/site-packages/functest/opnfv_tests/openstack/tempest/custom_tests/tempest_conf.yaml \
      -v ${FUNCTEST_CACHE}/blacklist.yaml:/usr/lib/python2.7/site-packages/functest/opnfv_tests/openstack/rally/blacklist.yaml \
      ...
      -v /home/ubuntu/nc/functest/functest/core/tenantnetwork.py:/usr/lib/python2.7/site-packages/functest/core/tenantnetwork.py \
      -v /home/ubuntu/nc/functest/functest/core/singlevm.py:/usr/lib/python2.7/site-packages/functest/core/singlevm.py \
      -v /home/ubuntu/nc/functest/functest/ci/testcases.yaml:/usr/lib/python2.7/site-packages/functest/ci/testcases.yaml \
      -v /home/ubuntu/nc/functest/functest/utils/env.py:/usr/lib/python2.7/site-packages/functest/utils/env.py \
      -v /home/ubuntu/nc/functest/functest/opnfv_tests/openstack/api/connection_check.py:/usr/lib/python2.7/site-packages/functest/opnfv_tests/openstack/api/connection_check.py \
      -v /home/ubuntu/nc/functest/functest/opnfv_tests/openstack/rally/scenario/sanity/opnfv-nova.yaml:/usr/lib/python2.7/site-packages/functest/opnfv_tests/openstack/rally/scenario/sanity/opnfv-nova.yaml \
